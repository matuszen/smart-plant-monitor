...
inline constexpr uint8_t  SOIL_MOISTURE_PIN           = 27;
inline constexpr uint8_t  SOIL_MOISTURE_ADC           = 1;
...
inline constexpr bool     WATER_LEVEL_I2C_ENABLED       = false;
...
inline constexpr uint8_t  WATER_LEVEL_RESISTIVE_ADC_PIN       = 26;
inline constexpr uint8_t  WATER_LEVEL_RESISTIVE_ADC_CHANNEL   = 0;
inline constexpr uint8_t  WATER_LEVEL_RESISTIVE_SAMPLES       = 8;
inline constexpr uint16_t WATER_LEVEL_RESISTIVE_LOW_THRESHOLD = 600;
